...
**Master of Philosophy in Engineering**, _The University of Edinburgh_, Edinburgh, UK
...
**Master of Science in Physics**, _University College Cork_, Cork, Ireland
...
**Quality and Commissioning Technician**, Tornado Storage Solutions, Edinburgh, UK

_Controls & Automation Proficiency_

- Developed a working knowledge of PLC-driven automation, enabling faster troubleshooting and better collaboration with control engineers.
- Supported troubleshooting and optimisation of PLC-controlled systems in R&D and production environments.

_Manufacturing Process Standardisation_

- Led the documentation of work instructions (WIs) and process failure analysis (P-FMEAs) for sub-assembly builds, reducing inefficiencies in manufacturing workflows.
- Collaborated with mechanical engineering and production teams to ensure seamless assembly and testing of critical components before shipment.

_Data-Driven Engineering Insights_

- Developed a closed-loop system linking failure tickets to engineering change requests, improving the tracking of recurring faults and design weaknesses.
- Developed data analytics metrics to identify failure trends, providing insights that drug design improvements and reduce product failures.

_Cross-Functional Collaboration & Process Improvement_

- Worked across engineering production and automation teams to streamline processes and enhance product quality.
- Facilitated inter-departmental knowledge sharing on automation best practices and failure prevention strategies.
...
- Leaded the training of AI models with human-in-the-loop feedback from prompts and responses.
- Carefully evaluated and rank responses generated by AI systems, ensuring top-notch quality and efficacy.
